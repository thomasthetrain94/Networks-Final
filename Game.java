...
public class Game {
     ...
     */
    //Checks to see if the String id equals the game id
     ...
     */
    // Return the amount of players in a game
     ...
     */
    //Returns a Scorebroad style hashmap of players
    //Decently important method to us
...
class ChallengeResponseGame extends Game {
     ...
     */
    //Grabs the questions that were created
    //Can have the server ask a question
...
class Question {
    ...
    public Question(String id, String question, String answer, int points) {
        //initalizes itself with the game methods
        this.id = id;
